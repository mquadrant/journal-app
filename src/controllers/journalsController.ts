...
export const createJournal = async function(
    req: Request,
    res: Response,
    _next: NextFunction
) {
...
export const getAllUserJournals = async function(
    req: Request,
    res: Response,
    _next: NextFunction
) {
...
export const getSingleUserJournal = async function(
    req: Request,
    res: Response,
    _next: NextFunction
) {
...
export const updateJournal = async function(
    req: Request,
    res: Response,
    _next: NextFunction
) {
...
export const deleteJournal = async function(
    req: Request,
    res: Response,
    _next: NextFunction
) {
